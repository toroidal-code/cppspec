...
struct TestClass {
  ...
  TestClass(std::string field1, std::string field2) : field1(field1), field2(field2) {};
};
...
// clang-format on
CPPSPEC_MAIN(describe_a_implicit_spec, describe_a_explicit_spec, describe_a_syntax_spec);
